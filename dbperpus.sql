...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 15, 2026 at 09:57 AM
...
CREATE TABLE `buku` (
  ...
  `kategori` enum('Novel','Ilmu Pengetahuan & Sejarah','Kitab') NOT NULL,
...
INSERT INTO `riwayat` (`id_riwayat`, `nama`, `judul_buku`, `tanggal_pinjam`, `tanggal_kembali`, `status`) VALUES
(6, 'qq', 'aa', '2026-06-15', NULL, 'Dipinjam'),
(7, 'aku', 'bos', '2026-06-15', '2026-06-15', 'Dikembalikan'),
(8, 'aku', 'bus', '2026-06-15', '2026-06-15', 'Dikembalikan'),
(9, 'aku', 'bis', '2026-06-15', '2026-06-15', 'Dikembalikan');
...
INSERT INTO `users` (`id`, `member_id`, `nama`, `password`, `role`) VALUES
(1, 'admin', '', '123', 'member'),
(10, '1000', 'admin1', '123', 'member');
